...
module('Integration | Component | geojson layer', function (hooks) {
  ...
  test('render geoJSON as SVG and Markers', async function (assert) {
    ...
    assert.dom('.leaflet-overlay-pane path').hasAttribute('d');
  ...
  test('update color on event', async function (assert) {
    ...
    assert.dom('.leaflet-overlay-pane path').hasAttribute('fill', 'green', 'Original fill set');
    ...
    assert.dom('.leaflet-overlay-pane path').hasAttribute('stroke', 'red', 'Mouseover stroke set');
    assert.dom('.leaflet-overlay-pane path').hasAttribute('fill', 'red', 'Mouseover fill set');
    ...
    assert.dom('.leaflet-overlay-pane path').hasAttribute('stroke', 'blue', 'Mouseleave stroke set');
    assert.dom('.leaflet-overlay-pane path').hasAttribute('fill', 'blue', 'Mouseleave fill set');
  });
